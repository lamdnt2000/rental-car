...
public class FilterDispatcher implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        Map<String, String> indexPage = (Map<String, String>) sc.getAttribute("INDEXPAGE");
        ...
        try {
            ...
            String url = indexPage.get(resource);
            HttpSession session = req.getSession(false);
            TblMemberDTO member = null;

            if (session != null) {
                member = (TblMemberDTO) session.getAttribute("RESULTLOGIN");
            }
            ...
            } else if (url != null && !url.endsWith("Servlet")) {
                if (member != null) {
                    if (member.getRole().equals("admin") && !uri.startsWith(path + "/admin")) {
                        redirect = true;
                        url = path + "/admin";
                    } else if (member.getRole().equals("member") && uri.startsWith(path + "/admin")) {
                        redirect = true;
                        url = path;
                    }
                }
